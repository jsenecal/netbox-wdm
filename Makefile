...
.PHONY: lint format check test test-fast migrations migrate runserver superuser collectstatic sample-data verify validate build clean ts-install ts-build ts-typecheck help
