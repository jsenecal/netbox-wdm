/**
 * Channel trace — unified horizontal flow diagram inspired by NetBox cable trace.
 *
...
// ── Render ──────────────────────────────────────────────────────
function renderChannelTrace(sel: string, ttSel: string, dataList: TraceData[]): void {
